...
class SnappyI18n {
    ...
    // 🌐 Nyelv felismerés böngésző alapján
    detectLanguage() {
        // Először elmentett nyelvet keresünk
        ...
        // Ha nincs mentett nyelv, böngésző nyelvét használjuk
        ...
        // Fallback: magyar
        console.log('🇭🇺 Using default Hungarian language');
        return 'hu';
    }
